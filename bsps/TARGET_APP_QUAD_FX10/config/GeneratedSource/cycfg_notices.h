...
#if !defined(CYUSB4014_FCAXI)
#error "Unexpected MPN; expected DEVICE:=CYUSB4014-FCAXI. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CYUSB4014_FCAXI) */
