...
#define CY_CFG_SYSCLK_ECO_GPIO_IN_PRT GPIO_PRT5
#define CY_CFG_SYSCLK_ECO_GPIO_IN_PIN 0
#define CY_CFG_SYSCLK_ECO_GPIO_OUT_PRT GPIO_PRT5
...
#define CY_CFG_SYSCLK_FLL_MULT 498U
#define CY_CFG_SYSCLK_FLL_REFDIV 81U
#define CY_CFG_SYSCLK_FLL_CCO_RANGE CY_SYSCLK_FLL_CCO_RANGE0
#define CY_CFG_SYSCLK_FLL_ENABLE_OUTDIV true
#define CY_CFG_SYSCLK_FLL_LOCK_TOLERANCE 6U
...
#define CY_CFG_SYSCLK_FLL_CCO_FREQ 109U
#define CY_CFG_SYSCLK_FLL_OUT_FREQ 24600000
...
#define CY_CFG_SYSCLK_PLL1_FEEDBACK_DIV 48
#define CY_CFG_SYSCLK_PLL1_REFERENCE_DIV 2
#define CY_CFG_SYSCLK_PLL1_OUTPUT_DIV 4
#define CY_CFG_SYSCLK_PLL1_LF_MODE true
...
#define CY_CFG_SYSCLK_CLKHF1_DIVIDER CY_SYSCLK_CLKHF_DIVIDE_BY_4
...
#define CY_CFG_SYSCLK_CLKHF3_DIVIDER CY_SYSCLK_CLKHF_DIVIDE_BY_8
...
__STATIC_INLINE void Cy_SysClk_EcoInit(void)
{
    (void)Cy_GPIO_Pin_FastInit(GPIO_PRT5, 0, CY_GPIO_DM_ANALOG, 0UL, HSIOM_SEL_GPIO);
    (void)Cy_GPIO_Pin_FastInit(GPIO_PRT5, 1, CY_GPIO_DM_ANALOG, 0UL, HSIOM_SEL_GPIO);
...
__STATIC_INLINE void Cy_SysClk_ClkHf3Init(void)
{
    ...
    Cy_SysClk_ClkHfSetDivider(CY_CFG_SYSCLK_CLKHF3, CY_SYSCLK_CLKHF_DIVIDE_BY_8);
