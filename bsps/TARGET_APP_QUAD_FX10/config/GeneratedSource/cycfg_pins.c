...
{
    Cy_GPIO_SetDriveSelTrim(ioss_0_port_5_pin_0_PORT, ioss_0_port_5_pin_0_PIN, CY_GPIO_DRIVE_STRENGTH_DEFAULT);
    Cy_GPIO_SetDriveSelTrim(ioss_0_port_5_pin_1_PORT, ioss_0_port_5_pin_1_PIN, CY_GPIO_DRIVE_STRENGTH_DEFAULT);
    Cy_GPIO_Pin_Init(ioss_0_port_8_pin_0_PORT, ioss_0_port_8_pin_0_PIN, &ioss_0_port_8_pin_0_config);
    Cy_GPIO_SetDriveSelTrim(ioss_0_port_8_pin_0_PORT, ioss_0_port_8_pin_0_PIN, CY_GPIO_DRIVE_STRENGTH_DEFAULT);
    Cy_GPIO_Pin_Init(ioss_0_port_8_pin_1_PORT, ioss_0_port_8_pin_1_PIN, &ioss_0_port_8_pin_1_config);
    Cy_GPIO_SetDriveSelTrim(ioss_0_port_8_pin_1_PORT, ioss_0_port_8_pin_1_PIN, CY_GPIO_DRIVE_STRENGTH_DEFAULT);
    Cy_GPIO_Pin_Init(ioss_0_port_10_pin_0_PORT, ioss_0_port_10_pin_0_PIN, &ioss_0_port_10_pin_0_config);
    Cy_GPIO_SetDriveSelTrim(ioss_0_port_10_pin_0_PORT, ioss_0_port_10_pin_0_PIN, CY_GPIO_DRIVE_STRENGTH_DEFAULT);
    Cy_GPIO_Pin_Init(ioss_0_port_10_pin_1_PORT, ioss_0_port_10_pin_1_PIN, &ioss_0_port_10_pin_1_config);
    Cy_GPIO_SetDriveSelTrim(ioss_0_port_10_pin_1_PORT, ioss_0_port_10_pin_1_PIN, CY_GPIO_DRIVE_STRENGTH_DEFAULT);
    Cy_GPIO_Pin_Init(ioss_0_port_11_pin_2_PORT, ioss_0_port_11_pin_2_PIN, &ioss_0_port_11_pin_2_config);
    Cy_GPIO_SetDriveSelTrim(ioss_0_port_11_pin_2_PORT, ioss_0_port_11_pin_2_PIN, CY_GPIO_DRIVE_STRENGTH_DEFAULT);
    Cy_GPIO_Pin_Init(ioss_0_port_11_pin_3_PORT, ioss_0_port_11_pin_3_PIN, &ioss_0_port_11_pin_3_config);
    Cy_GPIO_SetDriveSelTrim(ioss_0_port_11_pin_3_PORT, ioss_0_port_11_pin_3_PIN, CY_GPIO_DRIVE_STRENGTH_DEFAULT);
}
